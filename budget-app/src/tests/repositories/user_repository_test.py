...
class TestUserRepository(unittest.TestCase):
    ...
    def test_find_all(self):
        user_repository.add_user(self.user_esimerkki.username, self.user_esimerkki.password)
        user_repository.add_user(self.user_olio.username, self.user_olio.password)
    ...
    def test_find_account(self):
        user_repository.add_user(self.user_esimerkki.username, self.user_esimerkki.password)
        user = user_repository.find_account(self.user_esimerkki.username, self.user_esimerkki.password)
